    ...
    <div>
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="mt-5 w-full">
            <Link to="../captain-home" onClick={() => { props.setfinisRidePanal(false) }} className="w-full mt-5 flex justify-center bg-green-600 text-white font-xlg p-2 rounded-lg" > Complete Ride </Link>
            <p className="text-xsm mt-6">Click on complete ride button if you <b>completed the peyment</b></p>
        </div>
      </div>
    </div>
  )
