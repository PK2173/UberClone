  ...
  return (
    <div>
        ...
        <div className="flex gap-2 justify-between flex-col items-center">
          ...
          <Link to='../captain-rinding' onClick={()=>{
            props.setridePopPanel(false)
          ...
          <button onClick={()=>{props.setConfirmridePopPanel(false)}} className="w-full mt-1 bg-red-600 text-gray-700 font-semibold p-2 rounded-lg">
            Cancel
          </button>
        </div>
    </div>
